...
package com.example.recyclerviewanimals.databinding;
...
import com.example.recyclerviewanimals.R;
...
public final class RowBinding implements ViewBinding {
  ...
  private RowBinding(@NonNull LinearLayout rootView, @NonNull TextView tvAnimal) {
    this.rootView = rootView;
    this.tvAnimal = tvAnimal;
  }
  ...
  public static RowBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      id = R.id.tvAnimal;
      TextView tvAnimal = ViewBindings.findChildViewById(rootView, id);
      if (tvAnimal == null) {
        break missingId;
      }

      return new RowBinding((LinearLayout) rootView, tvAnimal);
    }
